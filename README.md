...
* Found and tried to fix an error with GNU/Linux compilation system that did not provide some needed libraries to the local build system.  Note that the OS-X build was, and still is Ok.
