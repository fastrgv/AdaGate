...
https://github.com/fastrgv/AdaGate/releases/download/v6.4.1/ag23aug18.tar.gz
...
Focusing on portability, transparency, and open source freedom, this project relies exclusively on F.O.S.S. tools:  a thin SDL2 binding, a thin OpenGL binding from "Lumen", a PNG reader by Stephen Sanguine & Dimitry Anisimkov, SFML-Audio with a homebrew binding, and a GNAT compiler.
